              ...
              child: PrimaryButton(
                ...
                onPressFunction: _saving
                    ...
                    : () async {
                        ...
                        try {
                          int hour24 = (_selectedHour % 12) + (isPM ? 12 : 0);
                          DateTime localStartTime = DateTime(
                            _selectedDate.year,
                            _selectedDate.month,
                            _selectedDate.day,
                            hour24,
                          ...
                          DateTime localEndTime = localStartTime.add(
                            Duration(
                                hours: _selectedHours,
                                minutes: _selectedMinutes),
                          );

                          DateTime utcStartTime = localStartTime.toUtc();
                          DateTime utcEndTime = localEndTime.toUtc();

                          print("--- EditMatchScreen SAVE --- G Debug --- ");
                          print("Device Timezone Offset: ${DateTime.now().timeZoneOffset}");
                          print("Selected Date (from calendar picker state): $_selectedDate");
                          print("Selected Time (from picker state): $_selectedHour : $_selectedMinute ${isPM ? 'PM' : 'AM'}");
                          print("Constructed Local StartTime: $localStartTime");
                          print("Constructed UTC StartTime to be saved: $utcStartTime");
                          print("Constructed Local EndTime: $localEndTime");
                          print("Constructed UTC EndTime to be saved: $utcEndTime");
                          print("-------------------------------------");
