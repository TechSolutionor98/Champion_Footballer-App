...
class _DashboardScreen2State extends ConsumerState<DashboardScreen2> {
  ...
  bool _isLeagueMenuOpen = false; // Add this state variable
  ...
  int calculateAverageSkill(dynamic attributes) {
    if (attributes == null) return 0;

    final keys = ['pace', 'shooting', 'passing', 'defending', 'dribbling', 'physical'];
    final values = keys.map((k) {
      int? attrValue;
      switch (k) {
        case 'pace':
          attrValue = attributes.pace;
          break;
        case 'shooting':
          attrValue = attributes.shooting;
          break;
        case 'passing':
          attrValue = attributes.passing;
          break;
        case 'defending':
          attrValue = attributes.defending;
          break;
        case 'dribbling':
          attrValue = attributes.dribbling;
          break;
        case 'physical':
          attrValue = attributes.physical;
          break;
      }
      
      if (attrValue != null && attrValue >= 0 && attrValue <= 99) {
        return attrValue;
      }
      return 0;
    }).toList();
  ...
  final List<Level> levels = [
    ...
    Level(
        level: 8,
        min: 4000, max: 5000, title: "Supreme Player", color: "bronze"),
    Level(
        level: 9,
        min: 5000, max: 6000, title: "The Invincible", color: "bronze"),
    Level(
        level: 10, min: 6000, max: 7000, title: "The Maestro", color: "bronze"),
    Level(
        level: 11,
        min: 7000, max: 8000, title: "Crème de la Crème", color: "bronze"),
    Level(level: 12, min: 8000, max: 9000, title: "Elite", color: "silver"),
    Level(
        level: 13,
        min: 9000, max: 10000, title: "World-Class", color: "silver"),
    Level(
        level: 14,
        min: 10000, max: 12000, title: "The Undisputed", color: "silver"),
    Level(level: 15, min: 12000, max: 15000, title: "Icon", color: "silver"),
    Level(
        level: 16,
        min: 15000, max: 18000, title: "Generational Talent", color: "gold"),
    Level(
        level: 17,
        min: 18000, max: 22000, title: "Legend of the Game", color: "gold"),
    Level(
        level: 18,
        min: 22000, max: 25000, title: "Football Royalty", color: "gold"),
    Level(
        level: 19,
        min: 25000, max: 30000, title: "Hall of Famer", color: "gold"),
    Level(
        level: 20,
        min: 30000, max: 99999999, title: "Champion Footballer", color: "black"),
  ];
  ...
  String formatLeagueName(String? name) {
    if (name == null || name.isEmpty) return '';
    final words = name.split(' ');
    final capitalizedWords = words.map((word) =>
        word.isEmpty ? '' : word[0].toUpperCase() + word.substring(1).toLowerCase()
    ).toList();
    final firstChars = words.map((word) => word.isEmpty ? '' : word[0].toUpperCase()).toList();
                      ...
                      child: Column(children: [
                        userAsync.when(
                            ...
                            data: (user) {
                              ...
                              calculateAverageSkill(attributes);
                              final attrList = [
                                attributes?.pace,
                                attributes?.shooting,
                                attributes?.passing,
                                        ...
                                        children: [
                                          ...
                                          if (skillPercentage >= 60) ...[
                                            ...
                                            Container(
                                              ...
                                              //   border: Border.all(
                                              //     color: kdefwhiteColor.withOpacity(0.3),
                                              //     width: 1,
                                              //   ),
                                              // ),
                                              child: Text(
                        ...
                        userAsync.when(
                          ...
                          data: (user) {
                            ...
                            final selectedLeagueForButton = ref.watch(selectedLeagueProvider);
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  userLeaguesAsync.when(
                                      data: (leaguesFromNewProvider) {
                                        if (selectedLeagueForButton == null && leaguesFromNewProvider.isNotEmpty) {
                                          WidgetsBinding.instance.addPostFrameCallback((_) {
                                            if (mounted) {
                                              ref.read(selectedLeagueProvider.notifier).state = leaguesFromNewProvider.last;
                                            }
                                          });
                                        }

                                        if (leaguesFromNewProvider.isNotEmpty) {
                                          String buttonLeagueName = "Select League";
                                          LeaguesJoined? leagueToDisplayOnButton = selectedLeagueForButton;

                                          if (leagueToDisplayOnButton == null && leaguesFromNewProvider.isNotEmpty) {
                                            leagueToDisplayOnButton = leaguesFromNewProvider.first;
                                          }
                                          buttonLeagueName = leagueToDisplayOnButton?.name?.trim() ?? "Unnamed League";

                                          // Get list of administered league IDs
                                          final administeredLeagueIds = user.administeredLeagues?.map((l) => l.id).toSet() ?? {};

                                          // Sort leagues alphabetically by name (A to Z)
                                          final sortedLeagues = [...leaguesFromNewProvider]..sort((a, b) {
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      borderRadius: _isLeagueMenuOpen 
                                                          ? BorderRadius.only(
                                                    ...
                                                    child: Material(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        borderRadius: _isLeagueMenuOpen 
                                                            ...
                                                            : BorderRadius.circular(8),
                                                        child: PopupMenuButton<LeaguesJoined>(
                                                          ...
                                                          onOpened: () {
                                                            setState(() {
                                                              _isLeagueMenuOpen = true;
                                                            });
                                                          },
                                                          onCanceled: () {
                                                            setState(() {
                                                              _isLeagueMenuOpen = false;
                                                            });
                                                          },
                                                          onSelected: (LeaguesJoined sl) async {
                                                            setState(() {
                                                              _isLeagueMenuOpen = false;
                                                            });
                                                            ...
                                                            ref.read(selectedLeagueProvider.notifier).state = sl;
                                                          ...
                                                          itemBuilder: (BuildContext context) {
                                                            return sortedLeagues.map((LeaguesJoined league) {
                                                              final isAdmin = administeredLeagueIds.contains(league.id);
                                                              
                                                              return PopupMenuItem<LeaguesJoined>(
                                                                value: league,
                                                                padding: EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                                                                child: Row(
                                                                  children: [
                                                                    Icon(Icons.emoji_events, color: Color(0xFFE7F6EF), size: 18),
                                                                    SizedBox(width: 8),
                                                                    Expanded(
                                                                      child: Text(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                        ...
                                                                        border: Border.all(
                                                                          color: isAdmin 
                                                                              ? Color(0xFF00A77F).withOpacity(0.65)
                                                                      ...
                                                                      child: Text(
                                                                        ...
                                                                        style: TextStyle(
                                                                          ...
                                                                          color: isAdmin ? Color(0xFF00A77F) : Colors.white,
                                                                          letterSpacing: 0.4,
                                                                        ),
                                                                      ),
                                                                    ),
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Expanded(
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child: Text(
                                                                          formatLeagueName(buttonLeagueName),
                                                                          style: TextStyle(
                                                                            fontSize: 16,
                                                                ...
                                                                AnimatedRotation(
                                                                  turns: _isLeagueMenuOpen ? 0.25 : 0.0,
                                      ...
                                      error: (err, stack) {
                                        print("[MainStartPage] Error in userLeaguesAsync.when: $err");
                                        return Text(
